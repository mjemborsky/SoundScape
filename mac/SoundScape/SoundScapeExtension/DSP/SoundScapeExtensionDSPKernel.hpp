//
//  SoundScapeExtensionDSPKernel.hpp
//  SoundScapeExtension
//
...
#import "SoundScapeExtension-Swift.h"
#import "SoundScapeExtensionParameterAddresses.h"

/*
 SoundScapeExtensionDSPKernel
 As a non-ObjC class, this is safe to use from render thread.
 */
class SoundScapeExtensionDSPKernel {
public:
    ...
    void setParameter(AUParameterAddress address, AUValue value) {
        switch (address) {
            case SoundScapeExtensionParameterAddress::gain:
                mGain = value;
                break;
                // Add a case for each parameter in SoundScapeExtensionParameterAddresses.h
        }
    }
    ...
    void process(std::span<float const*> inputBuffers, std::span<float *> outputBuffers, AUEventSampleTime bufferStartTime, AUAudioFrameCount frameCount) {
        /*
         ...
         modify the check in [SoundScapeExtensionAudioUnit allocateRenderResourcesAndReturnError]
         */
