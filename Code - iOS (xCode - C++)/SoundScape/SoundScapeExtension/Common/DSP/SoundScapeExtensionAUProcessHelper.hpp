//
//  SoundScapeExtensionAUProcessHelper.hpp
//  SoundScapeExtension
//
...
#include <vector>
#include "SoundScapeExtensionDSPKernel.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(SoundScapeExtensionDSPKernel& kernel, UInt32 inputChannelCount, UInt32 outputChannelCount)
    : mKernel{kernel},
...
private:
    SoundScapeExtensionDSPKernel& mKernel;
