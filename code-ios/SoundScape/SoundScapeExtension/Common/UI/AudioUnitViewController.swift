...
private let log = Logger(subsystem: "mje.SoundScapeExtension", category: "AudioUnitViewController")

public class AudioUnitViewController: AUViewController, AUAudioUnitFactory {
    var audioUnit: AUAudioUnit?
    
    var hostingController: HostingController<SoundScapeExtensionMainView>?
	...
	*/
    ...
    public func createAudioUnit(with componentDescription: AudioComponentDescription) throws -> AUAudioUnit {
        audioUnit = try SoundScapeExtensionAudioUnit(componentDescription: componentDescription, options: [])
        
        guard let audioUnit = self.audioUnit as? SoundScapeExtensionAudioUnit else {
            log.error("Unable to create SoundScapeExtensionAudioUnit")
            return audioUnit!
        }
        ...
        audioUnit.setupParameterTree(SoundScapeExtensionParameterSpecs.createAUParameterTree())
    ...
    private func configureSwiftUIView(audioUnit: AUAudioUnit) {
        ...
        let content = SoundScapeExtensionMainView(parameterTree: observableParameterTree)
